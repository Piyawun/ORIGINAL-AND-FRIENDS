        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="profile_edit.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="contact" class="col-sm-3 control-label">เบอร์โทรศัพท์</label>
                ...
                <div class="form-group">
                    <label for="address" class="col-sm-3 control-label">อยู่</label>
                ...
                <div class="form-group">
                    <label for="curr_password" class="col-sm-3 control-label">ยืนยันรหัสผ่าน</label>

                    <div class="col-sm-9">
                      <input type="password" class="form-control" id="curr_password" name="curr_password" placeholder="กรุณากรอกรหัสผ่าน" required>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
